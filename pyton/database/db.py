...
def init_db():
    ...
    cursor.execute("INSERT IGNORE INTO uzytkownicy (login, haslo, rola) VALUES ('klient', 'klient123', 'klient')")
    cursor.execute("INSERT IGNORE INTO kategorie (nazwa) VALUES ('Elektronika'), ('Odzież'), ('Sport')")
    cursor.execute("""
